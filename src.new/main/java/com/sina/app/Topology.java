...
public class Topology {
	...
	public static TopologyBuilder wireTopology(TopologyConfig topoConfig) {
		...
		builder.setBolt("clickToHbaseBolt",new ClickToHbaseBolt(),1)
				.shuffleGrouping("clickParseBolt","GETH");
		builder.setBolt("clickToKafkaBolt",new ToKafkaBolt(formatLog.brokerList,formatLog.pvclkTopic),1)
				.shuffleGrouping("clickParseBolt","GETK");
		builder.setBolt("clickFailToKafkaBolt",new ToKafkaBolt(formatLog.failbrokerList,formatLog.failTopic),1)
				.shuffleGrouping("clickParseBolt","NOGET");

		builder.setSpout("FailKafkaSpout",
				new FailKafkaSpout(formatLog.failTopic,"test"),1);
		builder.setBolt("failClickParseBolt",new FailClickParseBolt(),1)
				.shuffleGrouping("FailKafkaSpout");
		builder.setBolt("clickFailToHbaseBolt",new ClickToHbaseBolt(),1)
				.shuffleGrouping("clickParseBolt","GETH");
		builder.setBolt("clickFailToKafkaBolt",new ToKafkaBolt(formatLog.brokerList,formatLog.pvclkTopic),1)
				.shuffleGrouping("clickParseBolt","GETK");
